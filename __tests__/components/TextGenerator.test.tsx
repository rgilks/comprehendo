...
describe("TextGenerator Component", () => {
  ...
  it("generates a quiz when generate button is clicked", async () => {
    ...
    fireEvent.click(
      screen.getByRole("button", { name: /Generate English Reading Practice/i })
    );
    ...
    await waitFor(() => {
      expect(
        screen.getByText("Test paragraph for testing the component.")
      ).toBeInTheDocument();
      expect(
        screen.getByText("What is this paragraph about?")
      ).toBeInTheDocument();
    });
  });
  ...
  it("handles selecting an answer in the quiz", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText("Correct. The paragraph is about testing.")
      ).toBeInTheDocument();
    });
  });
  ...
  it("handles rate limit errors", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText(/You've reached the usage limit/i)
      ).toBeInTheDocument();
    });
  });
  ...
  it("allows changing language and CEFR level", async () => {
    ...
    fireEvent.click(
      screen.getByRole("button", { name: /Generate Spanish Reading Practice/i })
    );
  ...
  it("handles JSON parsing errors", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText(/Failed to parse the generated quiz/i)
      ).toBeInTheDocument();
    });
  });
  ...
  it("allows resetting the quiz", async () => {
    ...
    expect(
      screen.queryByText("Correct. The paragraph is about testing.")
